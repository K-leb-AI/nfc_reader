...
export default function EmployeeProfile() {
  ...
  return (
    <div className="min-h-screen bg-[#1c1c1e] flex flex-col items-center justify-center py-10 px-4">
      ...
      {employee && (
        <div className="w-full max-w-[320px] sm:max-w-none sm:w-auto">
          <div className="flex gap-4 mb-5">
            <input
              type="text"
              className="w-3/4 bg-[#242424] border border-white/6 placeholder:text-[#888] rounded-2xl px-5 py-4 text-sm text-white "
